...
// Project properties
group = project.findProperty("package_group") as? String ?: ""
...
//    compileOnly(rfg.deobf("curse.maven:modularmachinery-community-edition-817377:4991928"))
    ...
    implementation("org.mongodb:bson:3.12.10@jar")
    implementation("org.mongodb:mongodb-driver-core:3.12.10@jar")
    implementation("org.mongodb:mongodb-driver-sync:3.12.10@jar")
