...
public class ForgeTeam extends FinalIDObject implements INBTSerializable<NBTTagCompound>, IConfigCallback {
    ...
    public ConfigGroup getSettings() {
        if (cachedConfig == null) {
            ...
            cachedConfig.setDisplayName(new TextComponentTranslation("gui.settings").appendSibling(StringUtils.bold(StringUtils.color(new TextComponentString(" #" + this), TextFormatting.DARK_GRAY), false)));
